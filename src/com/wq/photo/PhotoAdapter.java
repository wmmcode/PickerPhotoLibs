...
public class PhotoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            if (currentChoseMode == CHOSE_MODE_MULTIPLE) {
                ...
                ivholder.checkBox.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        //更新主界面的UI
                        ((MediaChoseActivity)context).switchALLUI();
                    }
                });
                if (hashmap.containsKey(images)) {
                    ivholder.alpha_view.setVisibility(View.VISIBLE);
    ...
    /**
     * imageScaleType: EXACTLY :图像将完全按比例缩小的目标大小 EXACTLY_STRETCHED:图片会缩放到目标大小完全
    ...
    public void displayImage(String url, ImageView view) {
        // com.wq.photo.ImageLoader.getInstance(3,
        // com.wq.photo.ImageLoader.Type.LIFO)
        // .loadImage(url, view,sWidthPix/3,sWidthPix/3);
        // 显示图片
        Picasso.with(context).load("file://" + url).resize(sWidthPix / 3, sWidthPix / 3).placeholder(R.drawable.loadfaild)
